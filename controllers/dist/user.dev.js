...
exports.updatePassword = exports.registerAdmin = exports.loginAdmin = exports.getUsers = exports.Getme = exports.loginUser = exports.verifyOtpForNewUser = exports.sendOtpForNewUser = exports.sendOtpForNewAdmin = exports.verifyOtpForNewAdmin = exports.updatePasswordAdmin = exports.updateNumber = exports.deleteNumber = exports.sendOtpAgainForNewUser = void 0;
...
var PATA_SMS_PASSWORD = process.env.PATA_SMS_PASSWORD; //const jwt = require('jsonwebtoken')s;
...
var sendOtpAgainForNewUser = (0, _expressAsyncHandler["default"])(function _callee2(req, res) {
  var phoneNumber, user, newOtp, message, response;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 10:
          ...
          message = "Your new verification code is ".concat(newOtp);
          _context2.prev = 12;
          ...
          (0, _request["default"])({
            ...
            maxRedirects: 20,
            headers: {
              Authorization: "Basic ".concat(Buffer.from(PATA_SMS_USERNAME + ':' + PATA_SMS_PASSWORD).toString('base64')),
              'Content-Type': 'application/json',
              Cookie: 'CAKEPHP=207vs9u597a35i68b2eder2jvn'
            },
            json: {
        ...
        case 21:
          ...
          res.status(500).json({
            message: 'An error occurred while sending the new OTP'
          });
...
exports.sendOtpAgainForNewUser = sendOtpAgainForNewUser;
var sendOtpForNewAdmin = (0, _expressAsyncHandler["default"])(function _callee3(req, res) {
...
var verifyOtpForNewUser = (0, _expressAsyncHandler["default"])(function _callee4(req, res) {
...
var verifyOtpForNewAdmin = (0, _expressAsyncHandler["default"])(function _callee5(req, res) {
...
var registerAdmin = (0, _expressAsyncHandler["default"])(function _callee6(req, res) {
  ...
  return regeneratorRuntime.async(function _callee6$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 15:
          _hashedPassword = _context6.sent;
...
var loginUser = (0, _expressAsyncHandler["default"])(function _callee7(req, res) {
    ...
    while (1) {
      switch (_context7.prev = _context7.next) {
        ...
        case 10:
          ...
          _context7.t0 = user.isOtpVerified;
...
var loginAdmin = (0, _expressAsyncHandler["default"])(function _callee8(req, res) {
...
var updatePassword = (0, _expressAsyncHandler["default"])(function _callee9(req, res) {
  ...
  return regeneratorRuntime.async(function _callee9$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        ...
        case 13:
          _hashedPassword2 = _context9.sent;
...
var updatePasswordAdmin = (0, _expressAsyncHandler["default"])(function _callee10(req, res) {
  ...
  return regeneratorRuntime.async(function _callee10$(_context10) {
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 13:
          _hashedPassword3 = _context10.sent;
...
var Getme = (0, _expressAsyncHandler["default"])(function _callee11(req, res) {
...
exports.Getme = Getme;
var updateNumber = (0, _expressAsyncHandler["default"])(function _callee12(req, res) {
...
var deleteNumber = (0, _expressAsyncHandler["default"])(function _callee13(req, res) {
...
var getUsers = (0, _expressAsyncHandler["default"])(function _callee14(req, res) {
  var userExists;
